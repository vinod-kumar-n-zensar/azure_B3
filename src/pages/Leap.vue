<template>
        ...
        <div class="container-fluid">
                ...
                <div class="container common-div">
                    <div class="row common-mob-padd-fix cat-keep-container">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 imageContainer h-100" :style=style>
                    ...
                    <div class="row common-card toggleVolume">
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <button class="btn btn-primary btn-lg btn-block" v-on:click="toggle = !toggle"><span v-show="toggle">{{info.toggleVolume.toggleInfoSecondary.btnText}}</span><span v-show="!toggle">{{info.toggleVolume.toggleInfoPrimary.btnText}}</span></button>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 imageContainer hidden-xs hidden-sm hidden-md d-lg-block" >
                    ...
                    <div class="row common-card toggleVelocity common-mob-padd-fix">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <button class="btn btn-primary btn-lg btn-block" v-on:click="velocity = !velocity"><span v-show="velocity">{{info.toggleVelocity.toggleInfoSecondary.btnText}}</span><span v-show="!velocity">{{info.toggleVelocity.toggleInfoPrimary.btnText}}</span></button>
                            </div>
                        </div>
                    </div>
                    <div class="row common-card toggleVariety common-mob-padd-fix">
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <button class="btn btn-primary btn-lg btn-block" v-on:click="variety = !variety"><span v-show="variety">{{info.toggleVariety.toggleInfoSecondary.btnText}}</span><span v-show="!variety">{{info.toggleVariety.toggleInfoPrimary.btnText}}</span></button>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 imageContainer  hidden-xs hidden-sm hidden-md d-lg-block" >
                ...
                <div class="row common-card toggleDynamic common-mob-padd-fix">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <button class="btn btn-primary btn-lg btn-block" v-on:click="dynamic = !dynamic"><span v-show="dynamic">{{info.toggleDynamic.toggleInfoSecondary.btnText}}</span><span v-show="!dynamic">{{info.toggleDynamic.toggleInfoPrimary.btnText}}</span></button>
                            </div>
                        </div>
                </div>
                <div class="row common-card toggleGlobal common-mob-padd-fix">
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <button class="btn btn-primary btn-lg btn-block" v-on:click="global = !global"><span v-show="global">{{info.toggleGlobal.toggleInfoSecondary.btnText}}</span><span v-show="!global">{{info.toggleGlobal.toggleInfoPrimary.btnText}}</span></button>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 imageContainer hidden-xs hidden-sm hidden-md d-lg-block" >
    ...
    <div class="common-page-head leapFooter common-border-bottom" v-if="signed == 'true'">
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 imageContainer absContainer" >
